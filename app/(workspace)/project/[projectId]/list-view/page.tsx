...
import { Search, ListChecks, KanbanSquare, Layout } from "lucide-react";
            ...
            <form className="relative flex items-center flex-1 max-w-md">
              <div className="relative w-full group">
                ...
                <div className="relative flex">
                  <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground group-focus-within:text-secondary transition-colors duration-300" />
                  <Input
                    placeholder="Search tasks..."
                    className="w-full text-gray-300 pl-10 bg-muted/50 border-border focus:border-secondary/50 transition-all duration-300"
                  />
                </div>
              </div>
            </form>
